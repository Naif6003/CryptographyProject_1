...
public static void main(String args[]){
	...
	byte[] arr = {0,1,1,0,0}; // this will return A in ASCII 
	System.out.println(Convert( arr, 0, 4));
	
	char[] text = {'A'};
	System.out.println(Convert( text[0] ));
	...
	*/
	byte[] cas = {1,1,1,1,1}; // we add the pad to the end 
		System.out.println(toString( cas ));
