...
<<<<<<< HEAD
	/*
	 * 
	 * implementing the 3SDES 
	 * based on two interfaces :
	 *  	 
...
// ########################### A FUNCTION TO PRINT OUT THE RESULTS OF ENCRYPTION AND DECRYPTION. #######################################
	...
	public static void main(String[] args){
		 ...
		 byte[] encryptPlainText = Decrypt(key_1, Decrypt(key_2, Decrypt(key_1, plainText)));
	     printResultsEncryption(encryptPlainText);
		 
	     
	     byte[] cipher = {1,0,0,1,0,0,1,0};
	     byte[]  decryptCipherText = EncryptSDES(key_1, EncryptSDES(key_2, EncryptSDES(key_1 , cipher)));   
